const app = Vue.createApp({
    data(){
        return{
            ...
            cotacao:'',
            data:'',
            statusTooltip: false, // pra verificar se o Tooltip
    ...
    methods:{
        ...
        trocarCotacao(){
            ...
            if(this.dolarOnline){
                this.cotacao = Number(this.cotacaoOnline).toFixed(2)// Estamos coonvertendo texto para número para podermos utilizar a função toFixed()
            }
            else{
                this.cotacao = ""
            }
